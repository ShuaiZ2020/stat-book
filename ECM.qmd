...
knitr::include_graphics('image/Screenshot 2025-07-21 155606.png')
```
...
res1$T
```
打印结果显示 **T = 37**，与论文中的结果一致。接下来，利用公式 @eq-n2 计算疫苗组所需的样本量。为了方便重复使用，我将该计算过程封装成了函数 `T2N()`。
...
### HRV-三期
```{r, echo = F, out.width="100%"}
knitr::include_graphics('image/Screenshot 2025-07-22 173413.png')
```
...
```{r, echo = F, out.width="100%"}
knitr::include_graphics('image/Screenshot 2025-07-21 162616.png')
```
